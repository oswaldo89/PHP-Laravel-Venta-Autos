...
<head>
    ...
    <title>ElTianguisdelAutomovil - Registro</title>
            ...
            <div class="header-image">
                <div class="container">
                    <div class="auth-unit">
                        ...
                        <h3 class="text-brand"><span class="glyphicon glyphicon-dashboard"></span> ElTianguisdelAutomovil</h3>
                        ...
                        <div class="auth-unit-inner">
                            <form role="form" class="tooltip-demo">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control " id="exampleInputEmail1" placeholder="automarket">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Dirección de correo</label>
                                    <input type="email" class="form-control " id="exampleInputEmail2" placeholder="email@example.com" name="email">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Contraseña</label>
                                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="pass">
                                </div>
                                <button id="message_trigger_ok" class="btn btn-block btn-success" type="submit">Registrarse</button>
                                <hr>

                                <div class="btn-group btn-group-justified">
                                    <a class="btn btn-default btn-lg" data-toggle="tooltip" title="Login with Twitter" role="button"><i class="fa fa-twitter"></i></a>
                                    <a class="btn btn-default btn-lg" data-toggle="tooltip" title="Login in with Facebook" role="button"><i class="fa fa-facebook"></i></a>
                                    <a class="btn btn-default btn-lg" data-toggle="tooltip" title="Login in with Google+" role="button"><i class="fa fa-google-plus"></i></a>
                                    <a class="btn btn-default btn-lg" data-toggle="tooltip" title="Login in with Linkedin" role="button"><i class="fa fa-linkedin"></i></a>
                                </div>
