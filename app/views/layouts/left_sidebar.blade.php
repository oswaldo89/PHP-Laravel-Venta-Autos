<div class="col-md-3 col-sm-4">
    ...
    <div class="left-sec">
        ...
        <div class="left-cont">
            <h4>Suscribete para recibir actualizaciones. </h4>
            <p>Recibiras notificaciones de nuevos anuncios.</p>
            <form action="valid.json" id="valid_form" role="form">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nombre">
                    <br>
                    <input type="text" class="form-control" placeholder="Cuenta de correo">

                    <br>
                    <button id="message_trigger_ok" type="button" class="btn btn-warning  btn-block">Suscribir</button>
